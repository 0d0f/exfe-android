...
/*
 http://code.google.com/p/android-batsg/source/browse/trunk/android-batsg/src/com/chauhai/android/batsg/widget/RoundedCornerImageView.java
 */
public class RoundedCornerImageView extends ImageView {
	...
	public void setCornerRadius(float radius) {
		this.cornerRadius = radius * getContext().getResources().getDisplayMetrics().density;
	}
	
	public float getCornerRadius(){
		return  this.cornerRadius / getContext().getResources().getDisplayMetrics().density;
	}
		...
		if (drawable != null) {
			...
			if (viewWidth != 0f) { // Only round the corner if view width is not
				...
				if (bitmapCornerRadius != newBitmapCornerRadius) {
					...
					bitmap = Tool.getRoundedCornerBitmap(bitmap,
