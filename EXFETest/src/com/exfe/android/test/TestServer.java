...
public class TestServer extends
	...
	public final void testCheckLogin() {
		...
		String jsonStr = null;// mModel.getServer().checkLogin(Const.username,Const.pwd);
		try {
		...
		jsonStr = null;// mModel.getServer().checkLogin(Const.username,
						// Const.EMPTY);
		try {
			JSONObject json = new JSONObject(jsonStr);
	...
	public final void testSendRSVP() {
		...
		String jsonStr = null;// mModel.getServer().sendRSVP(123, "yes");
		try {
	...
	public final void testGetCrosses() {
		...
		Response response = mModel.getServer().getMyCrosses();
	...
	public final void testGetUpdatedCrosses() {
		...
		Response response = mModel.getServer().getNewCrossesAfter(d);
		assertEquals(200, response.getCode());
